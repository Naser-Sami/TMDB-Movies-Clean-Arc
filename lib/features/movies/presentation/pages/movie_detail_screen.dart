...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // LoggerDebug.loggerDebugMessage(id);
    return BlocProvider(
      create: (context) => sl<MoviesDetailsBloc>()
        ..add(GetMoviesDetailsEvent(id))
        ..add(
          GetMoviesRecommendationEvent(id),
        ),
      lazy: false,
          ...
          case RequestState.Loaded:
            ...
            return CustomScrollView(
              ...
              slivers: [
                SliverAppBar(
                  pinned: true,
                  expandedHeight: getFormFactor(context) == ScreenType.Desktop
                      ? 450
                      : 250.0,
        ...
        return SliverGrid(
          delegate: SliverChildBuilderDelegate(
            (context, index) {
              ...
              // LoggerDebug.loggerErrorMessage('recommendation $recommendation');

              // LoggerDebug.loggerDebugMessage(recommendation?.backdropPath);
              return FadeInUp(
                from: 20,
                duration: const Duration(milliseconds: 500),
                child: ClipRRect(
          ...
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            ...
            crossAxisCount:
                getFormFactor(context) == ScreenType.Desktop ? 4 : 3,
          ),
        );
      },
    );
